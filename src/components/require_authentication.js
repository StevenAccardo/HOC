...
//This is the skeleton or base of every HOC.
...
export default function(ComposedComponent) {
  class Authentication extends Component {
    //this gives any other component in our application the ability to reference Authentication.contectTypes
    //static defines a property on the class and not an instance of the class
    static contextTypes = {
